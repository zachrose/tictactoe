...
TictactoeGame.prototype.move = function(side, square){
    ...
    if(this.winner) throw errors.GameAlreadyOver;
    if(isNonsenseMove) throw errors.InvalidMove;
    if(side !== expectedSide) throw errors.NotYourTurn;
    if(alreadyFilled) throw errors.SquareTaken;
